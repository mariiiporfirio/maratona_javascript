...
// let usuario_numeros = prompt('Digite números inteiros separados por vírgula:');
...
console.log(`A palavra ${palavra} quanto invertida fica da seguinte forma: ${palavra_invertida()}.`);
console.log("___________________________________________________");
